...
QMAKE    = /usr/bin/qmake
BookShelf.xcodeproj/project.pbxproj: BookShelf.pro  /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o BookShelf.xcodeproj/project.pbxproj BookShelf.pro
